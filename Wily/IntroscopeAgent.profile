...
#                                                                      
# CA Wily Introscope(R) Version 9.0 Release 9.0.7.1
...
introscope.agent.enterprisemanager.transport.tcp.host.DEFAULT=clwpma4
...
introscope.agent.customProcessName=Default Process
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.agentName=Default Agent
...
introscope.changeDetector.rootDir=/applic/jboss/wily/change_detector
#######################
# Startup wait time 
#
# ================
